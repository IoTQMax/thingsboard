...
public abstract class BaseUserServiceTest extends AbstractServiceTest {
    ...
    public void before() {
        ...
        tenantAdmin.setEmail("tenant@effi.ai");
        userService.saveUser(tenantAdmin);

//THERA BEGIN
        User tenantIntegra = new User();
        tenantIntegra.setAuthority(Authority.TENANT_INTEGRA);
        tenantIntegra.setTenantId(tenantId);
        tenantIntegra.setEmail("installer@effi.ai");
        userService.saveUser(tenantIntegra);

        User tenantInstall = new User();
        tenantInstall.setAuthority(Authority.TENANT_INSTALL);
        tenantInstall.setTenantId(tenantId);
        tenantInstall.setEmail("integrator@effi.ai");
        userService.saveUser(tenantInstall);
//THERA END
        ...
        customerUser.setEmail("customer@effi.ai");
    ...
    public void testFindUserByEmail() {
        User user = userService.findUserByEmail(SYSTEM_TENANT_ID, "sysadmin@effi.ai");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.SYS_ADMIN, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "tenant@effi.ai");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.TENANT_ADMIN, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "customer@effi.ai");
        Assert.assertNotNull(user);
        Assert.assertEquals(Authority.CUSTOMER_USER, user.getAuthority());
        user = userService.findUserByEmail(tenantId, "fake@effi.ai");
    ...
    public void testSaveUser() {
        User tenantAdminUser = userService.findUserByEmail(SYSTEM_TENANT_ID,"tenant@effi.ai");
        User user = new User();
    ...
    public void testSaveUserWithSameEmail() {
        User tenantAdminUser = userService.findUserByEmail(tenantId, "tenant@effi.ai");
        tenantAdminUser.setEmail("sysadmin@effi.ai");
    ...
    public void testFindCustomerUsers() {
        User customerUser = userService.findUserByEmail(tenantId, "customer@effi.ai");
